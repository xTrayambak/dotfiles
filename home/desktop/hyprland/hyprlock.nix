  ...
  programs.hyprlock = {
    ...
    settings = {
      ...
      image = [
        {
          ...
          rounding = 8;
          border_size = 0;
          reload_cmd = "${inputs.self.packages.${pkgs.system}.scripts}/bin/music album-cover";
          position = "-150, -300";
          halign = "center";
          valign = "center";
        }
      ...
      label = [
        ...
        {
          monitor = "";
          text = ''cmd[update:3600000] echo $(${
            inputs.self.packages.${pkgs.system}.scripts
          }/bin/pretty_date lock_screen)'';
          font_size = 24;
          color = "rgb(255, 255, 255)";
          inherit font_family;
